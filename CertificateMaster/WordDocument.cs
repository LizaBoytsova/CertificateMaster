...
namespace CertificateMaster
{
    ...
    class WordDocument
    {
        ...
        /// <summary>
        /// Видимость на экране приложения Word, по умолчанию false
        /// </summary>
        public bool Visible
        {
            // документ создается невидимым и его надо явно сделать видимым после выполения необходимых операций
            get
            {
        ...
        /// <summary>
        /// Конструктор документа по шаблону
        /// </summary>
        ...
        /// <summary>
        /// Поиск первого вхождения текста в документе для свойства selectedText
        /// </summary>
        ...
        /// <summary>
        ///  Поиск и выбор текста в документе Word внутри строки-контейнера
        /// </summary>
        /// <param name="containerStr"></param>
        /// <param name="stringToFind"></param>
        public void SetSelectionToText(string containerStr, string stringToFind)
        {
            //сначала ищется контейнер, потом текст внутри него
        ...
        public void SetSelectionToCell(int rowIndex, int columnIndex)
        {
            ...
            _currentRange.Font.Color = Word.WdColor.wdColorBlack;
            _selection = new WordSelection(_currentRange, false);
        }

        /// <summary>
        /// Изменения цвета текста в ячейке на чёрный
        /// </summary>
        /// <param name="rowIndex"></param>
        /// <param name="columnIndex"></param>
        /// <param name="Color"></param>
        public void SetColorBlackToCell(int rowIndex, int columnIndex)
        {
            if (_table == null) { throw new Exception("Ошибка при выборе ячейки в таблице Word, не выбрана текущая таблица."); }
        ...
        /// <summary>
        /// вставляем пустой абзац, доступ к его тексту и свойствам
        /// </summary>     
        ...
        /// <summary>
        /// Установить ширину колонки выбранной таблицы
        /// </summary>
        /// <param name="columnIndex"></param>
        ...
        /// <summary>
        /// Вставка пустой страницы с одним параграфом в конце
        /// </summary>
        ...
        /// <summary>
        /// Втавка документа WORD из файла
        /// </summary>
        ...
        /// <summary>
        /// Сохранение файла с перезаписью
        /// </summary>
        ...
        /// <summary>
        /// Выбрать таблицу по порядковому номеру (с 1)
        /// </summary>
        ...
        /// <summary>
        /// Добавляем текст и новую пустую строку в конце таблицы
        /// </summary>
        /// <param name="Text"></param>
        /// <param name="NumberOfRow"></param>
        /// <param name="NumberOfColumn"></param>
        public void AddTextToTable(string Text, int NumberOfRow, int NumberOfColumn)
        {
            _table.Cell(NumberOfRow, NumberOfColumn).Range.Text = Text;
        }

        /// <summary>
        /// Добавляем пустую строку в таблице
        /// </summary>
        ...
        /// <param name="NumberOfRow"></param>
        /// <param name="NumberOfColumn"></param>
        public void DeleteCell(int NumberOfRow, int NumberOfColumn)
        {
            _table.Cell(NumberOfRow, NumberOfColumn).Delete(Word.WdDeleteCells.wdDeleteCellsShiftUp);
        }
        ...
        {
            // функция поиска Range  в документе Word строке
            //возвращает соответствующий строке Range, на входе строка для поиска
